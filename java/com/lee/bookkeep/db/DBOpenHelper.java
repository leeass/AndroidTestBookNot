...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sql = "create table accounttb(id integer primary key autoincrement, typeName varchar(10),sImageId integer,beizhu varchar(20),price integer, dateFormat varchar(20),year integer,month integer,day integer,kindId integer)";
        db.execSQL(sql);
    }
